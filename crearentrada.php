...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $queryInsertarEntrada = "
            INSERT INTO entradas (autor, categoria_id, titulo, descripcion, fecha, imagen)
            VALUES (:autor, :categoria_id, :titulo, :descripcion, :fecha, :imagen)
        ";
        ...
        <div class="row bg-light">
            <div class="col-12">
                <form method="POST" action="" enctype="multipart/form-data" class="p-5 m-5 needs-validation" novalidate>
                    ...
                    <input class="form-control w-50" type="text" name="autor" required pattern="[a-zA-Z0-9\s]{1,30}">
